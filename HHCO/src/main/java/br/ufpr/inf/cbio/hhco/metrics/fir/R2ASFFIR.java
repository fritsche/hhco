...
import br.ufpr.inf.cbio.hhco.metrics.utilityfunction.ASF;
 ...
 */
public class R2ASFFIR implements FitnessImprovementRateCalculator<Solution<?>> {

    private final double[][] lambda;
    private final int m;

    public R2ASFFIR(Problem problem, int populationSize) {
    ...
    public double computeFitnessImprovementRate(List<Solution<?>> parents, List<Solution<?>> offspring) {
        ...
        R2 r2 = new R2(lambda, reference, new ASF());
