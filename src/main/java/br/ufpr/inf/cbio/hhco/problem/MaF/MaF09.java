...
//range--line segment
        ...
        rx9[numberOfObjectives - 1][0] = p[numberOfObjectives - 1][0] <= p[0][0] ? p[numberOfObjectives - 1][0] : p[0][0];
        rx9[numberOfObjectives - 1][1] = p[numberOfObjectives - 1][0] <= p[0][0] ? p[0][0] : p[numberOfObjectives - 1][0];
        ry9[numberOfObjectives - 1][0] = p[numberOfObjectives - 1][1] <= p[0][1] ? p[numberOfObjectives - 1][1] : p[0][1];
        ry9[numberOfObjectives - 1][1] = p[numberOfObjectives - 1][1] <= p[0][1] ? p[0][1] : p[numberOfObjectives - 1][1];
        rangex9 = rx9;
        rangey9 = ry9;
...
//	evaluate f1,...m-1
        for (int i = 0; i < M9 - 1; i++) {
            if (r_polyline9[i][0] == 1) {
                ...
                f[i] = Math.abs((r_polyline9[i][1] * x[0] - x[1] + r_polyline9[i][2])) / Math.sqrt(Math.pow(r_polyline9[i][1], 2) + 1);
            }
        }
//	evaluate fm
        if (r_polyline9[M9 - 1][0] == 1) {
            ...
            f[M9 - 1] = Math.abs((r_polyline9[M9 - 1][1] * x[0] - x[1] + r_polyline9[M9 - 1][2])) / Math.sqrt(Math.pow(r_polyline9[M9 - 1][1], 2) + 1);
        }
...
//				System.out.println("ver!");
            ...
            if (r_polyline9[M9 - 1][0] == 1) {
                ...
                if (x[0] * r_polyline9[M9 - 1][1] + r_polyline9[M9 - 1][2] == x[1] && x[1] >= rangey9[M9 - 1][0] && x[1] <= rangey9[M9 - 1][1]
