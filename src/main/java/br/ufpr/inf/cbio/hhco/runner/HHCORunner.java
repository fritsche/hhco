...
public class HHCORunner {
    ...
    public static void main(String[] args) {
        try {
            ...
            HHCO hhco = new HHCOConfiguration(algorithmName).configure(popSize, maxFitnessevaluations, problem);
            JMetalLogger.logger.log(Level.CONFIG, "Algorithm: {0}", hhco.getName());
            ...
            Logger.getLogger(HHCORunner.class.getName()).log(Level.SEVERE, null, ex);
        }
